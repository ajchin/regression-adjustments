...
p_cai = ggnet2(g_cai, node.size=2, node.color=orange, edge.color=light_grey, edge.alpha=0.6) + 
...
p_fb = ggnet2(g_fb, node.size=2, node.color=orange, edge.color=light_grey, edge.alpha=0.6) + 
